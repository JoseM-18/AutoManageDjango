...
class Cotizacion(models.Model):
    ...
    id_inventario_vehiculos = models.ForeignKey('InventarioVehiculo', models.DO_NOTHING, db_column='id_inventario_vehiculos')
    id_vendedor = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='id_vendedor')
    id_cliente = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='id_cliente', related_name='cotizaciones_id_cliente_set', blank=True, null=True)
    fecha_creacion = models.DateTimeField(blank=True, null=True)
    fecha_vencimiento = models.DateTimeField(blank=True, null=True)
    valor_total = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
...
class InventarioPieza(models.Model):
    ...
    id_pieza = models.ForeignKey('Pieza', models.DO_NOTHING, db_column='id_pieza')
...
class Orden(models.Model):
    ...
    id_sucursal = models.ForeignKey('Sucursal', models.DO_NOTHING, db_column='id_sucursal')
    id_vendedor = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='id_vendedor')
    id_cliente = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='id_cliente', related_name='ordenes_id_cliente_set')
    fecha_creacion = models.DateTimeField(blank=True, null=True)
    fecha_finalizacion = models.DateTimeField(blank=True, null=True)
    tipo = models.CharField(max_length=50, blank=True, null=True)
    placa = models.CharField(max_length=10, blank=True, null=True)
    valor_mano_obra = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
    valor_total = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
...
class PiezasVehiculo(models.Model):
    id_pieza_vehiculo= models.AutoField(primary_key=True)
...
class Venta(models.Model):
    ...
    id_vendedor = models.ForeignKey(Usuario, models.DO_NOTHING, db_column='id_vendedor')
    id_cliente = models.ForeignKey(Usuario, models.DO_NOTHING, db_column='id_cliente', related_name='ventas_id_cliente_set')
    fecha_creacion = models.DateTimeField(blank=True, null=True)
    estado = models.CharField(max_length=50, blank=True, null=True)
    valor_total = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
